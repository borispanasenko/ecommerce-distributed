        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_categories_sort_order_non_negative", "sort_order >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_product_variants_currency_length", "char_length(currency) = 3");
                    table.CheckConstraint("ck_product_variants_price_amount_minor_non_negative", "price_amount_minor >= 0");
                    table.ForeignKey(
